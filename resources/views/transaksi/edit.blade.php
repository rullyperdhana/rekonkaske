        ...
        <form action="{{ route('transaksi.update', $transaksi->id) }}" method="POST" class="space-y-8" enctype="multipart/form-data">
            ...
            <div class="bg-surface-container-lowest border border-outline-variant rounded shadow-sm p-10 relative">
                ...
                <div class="mb-10 space-y-2">
                    ...
                    <textarea name="keterangan_selisih" class="w-full h-24 border-outline-variant rounded focus:border-primary focus:ring-1 focus:ring-primary p-3 bg-surface-container-lowest text-body-md resize-none" placeholder="Masukkan penjelasan perbedaan transaksi...">{{ old('keterangan_selisih', $transaksi->keterangan_selisih) }}</textarea>
