        ...
        <div class="bg-surface rounded border border-outline-variant shadow-sm overflow-hidden p-6">
            ...
            <form action="{{ route('user.store') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="nip" value="{{ old('nip') }}" placeholder="contoh: 19850115 201001 1 002" class="w-full h-10 px-3 rounded border border-outline-variant bg-surface text-body-md font-mono focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all">
                </div>
